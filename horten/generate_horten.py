...
# TRIM CONDITIONS
alpha_rad = 2.6204310487580043*np.pi/180
beta = 0.0
roll = 0.0
gravity = 'on'
cs_deflection = -0.15925559898087996*np.pi/180
thrust = 1.6346286563151664
sigma = 1
...
taper_ratio = 0.25
main_ea = 0.5 ## VERIFY, info not on richards
