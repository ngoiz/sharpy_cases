...
gain_struct_2_aero = np.block([[aeroelastic_system.Kdisp[:, :-4], zero_matrix],
                               [aeroelastic_system.Kvel_disp[:, :-4], aeroelastic_system.Kvel_vel[:, :-4]]])

gain_aero_2_struct = aeroelastic_system.Kforces[:-4, :]
...
beam.freq_natural = np.concatenate((beam.freq_natural[10:], beam.freq_natural[:6]))
