...
class HortenWing:
    ...
    def __init__(self,
        ...
        self.main_ea_root = self.loc_cg - self.ea_offset_root
        self.main_ea_tip = self.loc_cg - self.ea_offset_tip
    ...
    def update_fem_prop(self):
        ...
        main_ea_root = self.loc_cg - self.ea_offset_root
        main_ea_tip = self.loc_cg - self.ea_offset_tip
    ...
    def generate_fem_file(self):
        ...
        with h5.File(self.case_route + '/' + self.case_name + '.fem.h5', 'a') as h5file:
            ...
            structural_twist_handle = h5file.create_dataset(
                'structural_twist', data=np.zeros((self.n_node,)))
