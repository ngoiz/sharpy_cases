...
class FlyingWing():
    ...
    def __init__(self,
        ...
        self.main_ea = 0.5
        self.main_cg = 0.5
        self.c_ref=main_chord # ref. chord
    ...
    def update_mass_stiff(self, ea, ga, gj, eiy, eiz, mu, j_tors):
        ...
        self.mass[0, :, :]=np.diag([mu, mu, mu, j_tors[0], j_tors[1], j_tors[2]])
    ...
    def generate_fem_file(self):
        ...
        with h5.File(self.route+'/'+self.case_name+'.fem.h5','a') as h5file:
            ...
            structural_twist_handle = h5file.create_dataset(
                'structural_twist', data=np.zeros((self.num_elem_tot, self.num_node_elem)))
