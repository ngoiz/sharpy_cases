...
euler_init = np.array([0*np.pi/180, -40*np.pi/180, 0*np.pi/180])
...
phi_rot = np.hstack((phi_rot[:, :-9], phi_rot[:, -6:]))

beam.linearise_gravity_forces()
Mstr = phi_rot.T.dot(beam.Mstr.dot(phi_rot))
Cstr = phi_rot.T.dot(beam.Cstr.dot(phi_rot))
Kstr = phi_rot.T.dot(beam.Kstr.dot(phi_rot))
...
# Non linear results
datanl = pd.read_csv('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/nonlinear_theta40_sim.csv')
dt = T/N
...
# plt.grid()
# plt.legend()
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/Linear40Flex_BodyFrame.pdf')
fig.show()
...
# plt.grid()
# plt.legend()
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/Linear40Flex_InertialFrame.pdf')
fig.show()
...
ax[2].set_xlabel('Time, t [s]')
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/Linear40Flex_EulerAngles.pdf',
            bbox_inches="tight")
plt.show()
