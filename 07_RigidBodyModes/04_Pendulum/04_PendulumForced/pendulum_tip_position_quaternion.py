...
euler_init = np.array([5*np.pi/180, 5*np.pi/180, 0*np.pi/180])
...
eta0 = np.concatenate((eta0[:-7], np.array([0, 0, 0, 0, 0, 0, 0, 0])))

 # Initial condition - modal coordinate derivative
eta_dot_0 = np.zeros_like(eta0)
eta_dot_0[-4:] = algebra.euler2quat_ag(euler_init)
# eta_dot_0[-4] = 0.1
...
# plt.grid()
# plt.legend()
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/QuatLinearFlex_BodyFrame.pdf')
fig.show()
...
# plt.grid()
# plt.legend()
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/QuatLinearFlex_InertialFrame.pdf')
fig.show()
...
ax[2].set_xlabel('Time, t [s]')
plt.savefig('/home/ng213/sharpy_cases/07_RigidBodyModes/04_Pendulum/PLOTS/QuatLinearFlex_EulerAngles.pdf',
            bbox_inches="tight")
plt.show()
