...
print(aeroelastic_system.Kdisp.shape)
print(beam.num_dof)
gain_struct_2_aero = np.block([[aeroelastic_system.Kdisp[:, :-9], zero_matrix],
                     [aeroelastic_system.Kvel_disp[:, :-9], aeroelastic_system.Kvel_vel[:, :-9]]])

gain_aero_2_struct = aeroelastic_system.Kforces[:-9]
...
#    plt.savefig('./figs/mode_%d.pdf' % i)
#    plt.close()
# #    plt.show()
#
#
